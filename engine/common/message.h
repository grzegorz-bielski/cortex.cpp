...
struct ImageUrlContent : Content, JsonSerializable<ImageUrlContent> {
...
struct TextContent : Content, JsonSerializable<TextContent> {
  // Always text.
  ...
  struct FilePathWrapper : Annotation, JsonSerializable<FilePathWrapper> {
...
struct Refusal : Content, JsonSerializable<Refusal> {
